...
class Command(BaseCommand):
    ...
    def __init__(self):
        super().__init__()
        self.temperatura_atual = None #None: auxencia de valor
    ...
    def on_connect(self, client, userdata, flags, rc):
        if rc == 0:#rc: return code (retorna o código)
    ...
    def on_message(self, client, userdata, msg):
        try:
            ...
            elif msg.topic == "estufa/temperatura":
                self.umidade_atual = valor
                self.stdout.write(f"Temperatura: {valor}%")

            #se tivermos os dois valores, salve no banco de dados 
    ...
    def verificar_alerta(self):
        ...
        elif self.temperatura_atual < settings.TEMP_MIN: #comportamento da aplicação
            self.criar_alerta(
                "TEMP_BAIXA",
        ...
        elif self.umidade_atual < settings.UMIDADE_MAX:
            self.criar_alerta(
                "UMIDADE_BAIXA",
